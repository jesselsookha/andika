...
⎄ **25+ Student-Centred Templates** – Not just headings, but substantial boilerplate with placeholders that teach proper documentation structure while requiring students to actively edit and personalize their work.
...
4.  **Customize** – Each template includes `[placeholders]` and descriptive comments. **Students must edit these**—this is by design. Documentation is not copy-paste; it is communication.
...
The right panel renders your Markdown in **GitHub Flavored Markdown** style, including:

- Headers, lists, tables, blockquotes
- Syntax-highlighted code blocks
-  **Mermaid.js diagrams** – Use ` ```mermaid ` code blocks to create flowcharts, sequence diagrams, and more
...
gantt
    ...
    section Init
        Project Initialization  :a1, 2026-03-10, 30d
...
3. Choose alignment (left, center, right)
...
**To distribute & use without internet access:**

1. Download the three library files (`codemirror.min.js`, `marked.min.js`, `mermaid.min.js`)
...
Contributions are **welcome and appreciated**—this is a student-centered tool, and student feedback is the most valuable contribution of all.
...
- ⌕ Document statistics (reading time, grade level)
